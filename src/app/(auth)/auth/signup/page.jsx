...
const SignUp = () => {
  ...
  return (
    <div className='flex- w-full h-screen flex items-center justify-center overflow-hidden'>
      ...
      {/* -- Singin Section */}
      <section className='hidden w-2/5 bg-violet-dark h-full lg:flex relative items-center justify-center '>
        <svg
          version='1.1'
          ...
          filter='blur(2.2px)'
          transform='rotate(-6)'
          className='absolute -right-44 -bottom-[200px]'
        >
          <defs>
            <linearGradient id='gradient' x1='0%' y1='0%' x2='0%' y2='100%'>
              <stop
                offset='0%'
                style={{ stopColor: 'rgb(225, 71, 184)' }}
              ></stop>
              <stop
                offset='100%'
                style={{ stopColor: 'rgb(216, 65, 72)' }}
              ></stop>
            </linearGradient>
          </defs>
