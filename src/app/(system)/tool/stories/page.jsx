    ...
    <div className='w-full h-auto min-h-[800px] flex flex-col gap-3'>
      ...
      <div>
        <div className='divide-y divide-gray-200 rounded-lg sm:grid sm:grid-cols-2 sm:gap-3 sm:divide-y-0'>
          {stories.map((stories, idx) => (
            <div
              key={idx}
              className='relative group bg-white p-6 rounded-md focus-within:ring-2 focus-within:ring-inset shadow-md hover:shadow-xl duration-150 bg-white-main border'
            >
              <div>
              ...
              <div className='mt-8'>
                <h3 className='text-lg font-medium'>
                  <a href={stories.route} className='focus:outline-none'>
