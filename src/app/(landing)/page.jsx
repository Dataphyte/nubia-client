    ...
    <div className='page__container'>
      ...
      <section className='flex w-full h-[500px] items-center justify-center relative'>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className='w-72 h-[400px] rounded-3xl shadow-2xl z-10 bg-white-main border border-black-thin px-8 py-5 gap-1 flex flex-col items-center'
        >
          {/* ====== title */}
          <div className='w-full h-10 bg-gray-800 rounded mt-5' />

          {/* ====== body */}
          <div className='w-full h-2 bg-gray-500 rounded mt-3' />
          {[1, 2, 3, 4, 5, 6].map((item) => (
            <div className='w-full h-2 bg-gray-500 rounded' key={item} />
          ))}

          {/* ====== sub title */}
          <div className='w-full h-6 bg-gray-800 rounded mt-3' />
          <div className='w-full h-2 bg-gray-500 rounded mt-3' />
          {[1, 2, 3, 4, 5, 6].map((item) => (
            <div className='w-full h-2 bg-gray-500 rounded' key={item} />
          ))}
          <div className='w-2/3 h-8 bg-gray-800 rounded mt-3' />
        </motion.div>
