                            ...
                            <div className='sm:col-span-3'>
                              ...
                              <div className='mt-2'>
                                <select
                                  id='feature-type'
                                  name='feature-type'
                                  className='block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-violet-main sm:max-w-xs sm:text-sm sm:leading-6'
                                  onChange={(e) =>
                                    setLocalFeat((state) => ({
                                      ...state,
                                      type: e.target.value,
